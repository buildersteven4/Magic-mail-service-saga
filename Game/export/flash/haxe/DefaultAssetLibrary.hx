...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/maps/test1.csv", __ASSET__assets_maps_test1_csv);
		type.set ("assets/maps/test1.csv", AssetType.TEXT);
		className.set ("assets/maps/test1.tmx", __ASSET__assets_maps_test1_tmx);
		type.set ("assets/maps/test1.tmx", AssetType.TEXT);
		...
		id = "assets/maps/test1.csv";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/maps/test1.tmx";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_maps_test1_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_maps_test1_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_maps_test2_tmx extends flash.utils.ByteArray { }
...
@:file("assets/maps/test1.csv") #if display private #end class __ASSET__assets_maps_test1_csv extends lime.utils.Bytes {}
@:file("assets/maps/test1.tmx") #if display private #end class __ASSET__assets_maps_test1_tmx extends lime.utils.Bytes {}
